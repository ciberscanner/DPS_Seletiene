...
namespace DPS_Seletiene.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,RoleId,id")] AspNetUserRoles aspNetUserRoles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,RoleId,id")] AspNetUserRoles aspNetUserRoles)
        {
            if (ModelState.IsValid)
            {
